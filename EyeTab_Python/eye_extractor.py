...
class EyeRoi:
    ...
    def __init__(self, roi_params, img_param):

        roi_x0_param, roi_y0_param = roi_params
    ...
    def refine_pupil(self, pupil_coords, full_img):

        pupil_x0, pupil_y0 = pupil_coords
...
def choose_best_eye_pair(eye_pair_rects, img):
    ...
    return max(eye_pair_rects,
               key=lambda x0, y0, w, h: image_utils.measure_blurriness_LoG(img[y0:y0 + h, x0:x0 + w]))
